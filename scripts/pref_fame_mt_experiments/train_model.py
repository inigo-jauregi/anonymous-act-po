...
from src.ctrlpost.dataloaders import FameMtDataModule
...
def main(args):
    ...
    if '<FORMALITY>' in args.prompt:
        model.controllable = True
    else:
        model.controllable = False

    # Create data module
    datamodule = FameMtDataModule(
...
parser.add_argument('--og-data', action='store_true',
                    help='Use original FAME-MT train and validation data.')
